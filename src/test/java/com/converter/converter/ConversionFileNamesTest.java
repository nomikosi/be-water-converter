...
class ConversionFileNamesTest {
    ...
    void extensions() {
        assertThat(ConversionFileNames.extensionFor(ConversionPipeline.FMT_JSON)).isEqualTo("json");
        assertThat(ConversionFileNames.extensionFor(ConversionPipeline.FMT_XML)).isEqualTo("xml");
        assertThat(ConversionFileNames.extensionFor(ConversionPipeline.FMT_YAML)).isEqualTo("yaml");
        assertThat(ConversionFileNames.extensionFor(ConversionPipeline.FMT_CSV)).isEqualTo("csv");
    ...
    void javaAlwaysRootJava() {
        ...
        assertThat(ConversionFileNames.nameFor("customers.csv", ConversionPipeline.FMT_JAVA))
              .isEqualTo("Root.java");
        assertThat(ConversionFileNames.nameFor(null, ConversionPipeline.FMT_JAVA))
              .isEqualTo("Root.java");
    }
    ...
    void keepsBaseName() {
        ...
        assertThat(ConversionFileNames.nameFor("schema.proto", ConversionPipeline.FMT_YAML))
              .isEqualTo("schema.yaml");
    }

    @Test @DisplayName("a nameless source (editor selection) gets a generic name")
    void namelessSource() {
        assertThat(ConversionFileNames.nameFor(null, ConversionPipeline.FMT_XML))
              .isEqualTo("converted.xml");
        assertThat(ConversionFileNames.nameFor("  ", ConversionPipeline.FMT_XML))
              .isEqualTo("converted.xml");
    }

    @Test @DisplayName("names with several dots keep everything before the last one")
    void multipleDots() {
        assertThat(ConversionFileNames.nameFor("my.data.v2.json", ConversionPipeline.FMT_CSV))
    ...
    void dotfile() {
        ...
        assertThat(ConversionFileNames.nameFor(".gitignore", ConversionPipeline.FMT_JSON))
