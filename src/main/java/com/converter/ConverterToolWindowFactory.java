...
/** DumbAware: the converter has no index dependencies, so it works during indexing. */
public class ConverterToolWindowFactory implements ToolWindowFactory, DumbAware {
    @Override
